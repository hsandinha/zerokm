    ...
    try {
        ...
        return {
            ...
            creditCard: (user as any)?.creditCard ? {
                holderName: (user as any).creditCard.holderName || '',
                lastFour: (user as any).creditCard.lastFour || '',
                brand: (user as any).creditCard.brand || '',
                expiry: (user as any).creditCard.expiry || ''
            } : { holderName: '', lastFour: '', brand: '', expiry: '' }
        };
    } catch (error) {
