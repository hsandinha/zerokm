...
export function AddTransportadoraModal({
    ...
    const getCidadesSuggestions = useCallback((searchTerm: string): string[] => {
        ...
        <section className={styles.panel}>
            <div className={styles.header}>
                <div>
                    ...
                    <p>{isEditing ? 'Revise os dados logísticos e salve para atualizar o cadastro.' : 'Informe os dados para disponibilizar a nova transportadora.'}</p>
                </div>
