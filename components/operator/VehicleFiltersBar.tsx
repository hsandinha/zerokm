            ...
            <div className={styles.searchInfo}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1rem', flexWrap: 'wrap', width: '100%' }}>
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginTop: '8px' }}>
                        {searchTerm && (
                            <span style={{ background: 'var(--admin-selected, #eef)', border: '1px solid var(--admin-border, #99c)', borderRadius: '12px', padding: '4px 8px', display: 'inline-flex', alignItems: 'center', color: 'var(--admin-selected-text, #1a1a1a)' }}>
                                Busca: {searchTerm}
